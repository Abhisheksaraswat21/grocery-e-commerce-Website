...
//         }
//     }).then(res => {
//         //isme orders aare hai
//         orders = res.data
//         //generatemarkup is a function
...
//         //items ke andr item aur gty hai to uska array milega
//         let parsedItems = Object.values(items)
//         //uske upar bhi hum map chla rhe hai
//         // item me name hai uske baad ek qty KA BHi hai wo dono miljayegi
//         return parsedItems.map((menuItem) => {
//             //ab hume item ka naam aur uski quantity dikh jayegi aaram se..map hai to sb dikenge ek ek krke
//             //end me join is to join them   altogether
//             return `
...
//         `
//         }).join('')
//         //join mtlb map se milne wale array ko ek hi string me daal rhe hai
//     }
//     // Socket
//     //yha pe receive krre hai hum from server.js and app.js
...
//             progressBar: false,
//         }).show();
//         //unshift means order starting me add hoga array ke...push krte to order end me add hota array ke
//         orders.unshift(order)
//         orderTableBody.innerHTML = ''
//         //ab nya markup bangea and with new orders
...
var statuses = document.querySelectorAll('.status_line'); //hiddeninput me order are hai singleorder.ejs se

var hiddenInput = document.querySelector('#hiddenInput');
var order = hiddenInput ? hiddenInput.value : null; //humne order singleprderpage se lia and and ab usko wapas object me change krenge yha pe

order = JSON.parse(order); //ye hum small tag create krre hai isme---

var time = document.createElement('small'); //we are receiving orders from the singleorder page here ---
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    var dataProp = status.dataset.status; //step complete hone pr class add ki hai grey color krne waali, aur agr humaradataprop ki value database ke orderstatus se mili
    ...
    if (dataProp === order.status) {
      stepCompleted = false; //mongodb me database me updatedat pe humpe time hai

      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatedAt).format('hh:mm A'); //append child mtlb ki time variable me small tag lag jayega ab

      status.appendChild(time); //nextsibling means ki next item lelega ye
...
var adminAreaPath = window.location.pathname; //this checks if url is having admin in it or not

if (adminAreaPath.includes('admin')) {
  Object(_admin__WEBPACK_IMPORTED_MODULE_2__["initAdmin"])(socket); //yha unique room ni bna rhe bs ek hi room bna rhe hai  admin room
...
socket.on('orderUpdated', function (data) {
  ...
  updatedOrder.status = data.status; //update status changes colour and all
...
__webpack_require__(/*! /Users/abhisheksaraswat/Desktop/grocery-delivery-application/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/abhisheksaraswat/Desktop/grocery-delivery-application/resources/scss/app.scss */"./resources/scss/app.scss");
